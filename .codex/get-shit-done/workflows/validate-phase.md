...
```
Task(
  prompt="Read /Users/andreas/Library/Mobile Documents/com~apple~CloudDocs/Code/gsd-test/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/andreas/Library/Mobile Documents/com~apple~CloudDocs/Code/gsd-test/.codex/get-shit-done/templates/VALIDATION.md`
